...
public class OWLDataFactoryImpl implements OWLDataFactory, Serializable, OWLClassProvider {
	...
	@Override
	public OWLMetaRuleAxiom getOWLMetaRuleAxiom(
			OWLObjectPropertyExpression propertyR, OWLObjectPropertyExpression propertyS) {
		return getOWLMetaRuleAxiom(propertyR, propertyS, EMPTY_ANNOTATIONS_SET);
	}
	...
	public OWLMetaRuleAxiom getOWLMetaRuleAxiom(
			OWLObjectPropertyExpression propertyR, OWLObjectPropertyExpression propertyS,
			Set<? extends OWLAnnotation> annotations) {
		checkNotNull(propertyR, "propertyR");
		checkNotNull(propertyS, "propertyS");
		checkAnnotations(annotations);
		return new OWLMetaRuleAxiomImpl(propertyR, propertyS, annotations);
	}
